...
"Groups" in the concept of controlling multiple policies together.
This is the core of your code conventions, where you control which libraries should be used when using the group.
...
:::tip
You can easily switch group in your project by running the `exlint use <group_i>` command again!
:::
