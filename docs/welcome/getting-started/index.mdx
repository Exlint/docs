...
<div className="container py-5">
	<div className={styles.row}>
		<div className={styles.card}>
			<img src="/img/welcome/getting-started/helm.png" alt="helm" width="90" height="90" />
			<h4 style={{ margin: '16px 0 5px 0', fontSize: '21px', fontWeight: '800' }}>Using Helm?</h4>
			<p>
				Take a look at{' '}
				<a
		...
		<div className={styles.card}>
			<img src="/img/welcome/getting-started/kustomize.png" alt="kustomize" width="90" height="90" />
			<h4 style={{ margin: '16px 0 5px 0', fontSize: '21px', fontWeight: '800' }}>Using Kustomize?</h4>
			<p>
